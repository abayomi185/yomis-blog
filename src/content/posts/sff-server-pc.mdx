...
cover:
  image: /static/assets/posts/sff-server-pc/serverpc.jpg
  alt: SFF Server PC
tags: ['project']
---
...
export const virtManagerUI = '/static/assets/posts/sff-server-pc/virt-manager.png';
export const serverPCDiagram = '/static/assets/posts/sff-server-pc/server-pc-remote.jpg';
...
<div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
  <iframe
    ...
    allowfullscreen
  ></iframe>
  <PostImageCaption caption="SFF Server PC RAM Upgrade" />
</div>
...
<PostImage key={virtManagerUI} alt="Virt-Manager UI for KVM" />
...
<PostImage key={serverPCDiagram} alt="Home Lab Network Diagram" />
