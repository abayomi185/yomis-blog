...
cover:
  image: assets/posts/sff-server-pc/serverpc.jpg
  alt: SFF Server PC
tags: ['project']
---
...
export const virtManagerUI = 'assets/posts/sff-server-pc/virt-manager.png';
export const serverPCDiagram = 'assets/posts/sff-server-pc/server-pc-remote.jpg';
...
<R2Image key={virtManagerUI} alt="Virt-Manager UI for KVM" />
...
<R2Image key={serverPCDiagram} alt="Home Lab Network Diagram" />
