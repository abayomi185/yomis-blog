...
cover:
  image: /static/assets/posts/fresh-start-on-proxmox/Proxmox-logo-860.png
  alt: Proxmox Logo
tags: ['project']
---
...
export const linuxMeme = '/static/assets/posts/fresh-start-on-proxmox/alwayhasbeenlinux.jpg';
export const proxmoxDashboard =
  '/static/assets/posts/fresh-start-on-proxmox/Screenshot-2022-04-23-at-04.33.49.jpg';

export const nr200BuildGallery = [
  '/static/assets/posts/fresh-start-on-proxmox/computer_top.jpeg',
  '/static/assets/posts/fresh-start-on-proxmox/computer_front.jpeg',
  '/static/assets/posts/fresh-start-on-proxmox/intel_cpu.jpeg',
  '/static/assets/posts/fresh-start-on-proxmox/computer_side.jpeg',
  '/static/assets/posts/fresh-start-on-proxmox/computer_cpu_paste.jpeg'
];

> Please see my [previous blog post](/sff-server-pc) for context.
...
<PostImage key={linuxMeme} alt="Always has been Linux - source: r/linuxmemes by u/parkerlreed" />
...
<PostImage key={proxmoxDashboard} alt="Proxmox web interface" />

To briefly tell you what has changed from my [previous build](/sff-server-pc);
...
<PostImageGallery
  images={[
    { key: nr200BuildGallery[0] },
    { key: nr200BuildGallery[1] },
    { key: nr200BuildGallery[2] },
    { key: nr200BuildGallery[3] },
    { key: nr200BuildGallery[4] }
  ]}
