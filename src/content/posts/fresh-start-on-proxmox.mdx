...
cover:
  image: assets/posts/fresh-start-on-proxmox/Proxmox-logo-860.png
  alt: Proxmox Logo
tags: ['project']
---
...
export const linuxMeme = 'assets/posts/fresh-start-on-proxmox/alwayhasbeenlinux.jpg';
export const proxmoxDashboard =
  'assets/posts/fresh-start-on-proxmox/Screenshot-2022-04-23-at-04.33.49.jpg';

export const nr200BuildGallery = [
  'assets/posts/fresh-start-on-proxmox/computer_top.jpeg',
  'assets/posts/fresh-start-on-proxmox/computer_front.jpeg',
  'assets/posts/fresh-start-on-proxmox/intel_cpu.jpeg',
  'assets/posts/fresh-start-on-proxmox/computer_side.jpeg',
  'assets/posts/fresh-start-on-proxmox/computer_cpu_paste.jpeg'
];
...
<R2Image key={linuxMeme} alt="Always has been Linux - source: r/linuxmemes by u/parkerlreed" />
...
<R2Image key={proxmoxDashboard} alt="Proxmox web interface" />
