...
cover:
  image: /static/assets/posts/tailscale-openwrt/tailsclale_logo.png
  alt: Tailscale Logo
tags: ['guide']
---
...
export const luciWebInterface =
  '/static/assets/posts/tailscale-openwrt/Screenshot-2022-04-23-at-04.01.46.jpg';
export const ts0InterfaceOnLuci =
  '/static/assets/posts/tailscale-openwrt/Screenshot-2022-04-23-at-04.08.08.jpg';
...
<PostImage key={luciWebInterface} alt="Luci web interface showing tailscale device." />
...
<PostImage key={ts0InterfaceOnLuci} alt="Tailscale interface - TS0." />
