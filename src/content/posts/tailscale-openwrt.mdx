...
cover:
  image: assets/posts/tailscale-openwrt/tailsclale_logo.png
  alt: Tailscale Logo
tags: ['guide']
---
...
export const luciWebInterface =
  'assets/posts/tailscale-openwrt/Screenshot-2022-04-23-at-04.01.46.jpg';
export const ts0InterfaceOnLuci =
  'assets/posts/tailscale-openwrt/Screenshot-2022-04-23-at-04.08.08.jpg';
...
<R2Image key={luciWebInterface} alt="Luci web interface showing tailscale device." />
...
<R2Image key={ts0InterfaceOnLuci} alt="Tailscale interface - TS0." />
