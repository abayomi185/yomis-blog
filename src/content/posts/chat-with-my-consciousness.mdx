...
cover:
  image: /static/assets/posts/chat-with-my-consciousness/3.png
...
export const chatInterface = '/static/assets/posts/chat-with-my-consciousness/1.JPG';
export const openAIUsageDashboard = '/static/assets/posts/chat-with-my-consciousness/2.png';
export const updatedChatInterface = '/static/assets/posts/chat-with-my-consciousness/5.png';

> Check it out at [yomitosh.dev](https://yomitosh.dev)

The release of OpenAI's ChatGPT API was exciting and I was quick to sign up for access. I had used ChatGPT on the [web](https://chat.openai.com) that most are familiar with, but it was getting cumbersome having to sign in and verify that I am not in fact a robot.
...
<PostImage key={openAIUsageDashboard} alt="OpenAI dashboard showing API usage in April 2023" />
