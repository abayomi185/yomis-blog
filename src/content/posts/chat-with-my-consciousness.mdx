...
cover:
  image: assets/posts/chat-with-my-consciousness/3.png
...
export const chatInterface = 'assets/posts/chat-with-my-consciousness/1.JPG';
export const openAIUsageDashboard = 'assets/posts/chat-with-my-consciousness/2.png';
export const updatedChatInterface = 'assets/posts/chat-with-my-consciousness/5.png';
...
<R2Image key={openAIUsageDashboard} alt="OpenAI dashboard showing API usage in April 2023" />
