...
cover:
  image: /static/assets/posts/simple-intro-to-natural-language-processing-with-python/waveform-1.png
  alt: Waveform
tags: ['guide']
---
...
export const mfccPlot =
  '/static/assets/posts/simple-intro-to-natural-language-processing-with-python/mfcc.png';
export const waveformPlot =
  '/static/assets/posts/simple-intro-to-natural-language-processing-with-python/waveform-1.png';
export const lossPlot =
  '/static/assets/posts/simple-intro-to-natural-language-processing-with-python/loss.png';
...
<PostImage key={mfccPlot} alt="mfcc" />
...
<PostImage key={waveformPlot} alt="waveform" />
...
<PostImage key={lossPlot} alt="loss and validation loss graph" />
