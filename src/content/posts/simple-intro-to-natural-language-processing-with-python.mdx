...
cover:
  image: assets/posts/simple-intro-to-natural-language-processing-with-python/waveform-1.png
  alt: Waveform
tags: ['guide']
---
...
export const mfccPlot =
  'assets/posts/simple-intro-to-natural-language-processing-with-python/mfcc.png';
export const waveformPlot =
  'assets/posts/simple-intro-to-natural-language-processing-with-python/waveform-1.png';
export const lossPlot =
  'assets/posts/simple-intro-to-natural-language-processing-with-python/loss.png';
...
<R2Image key={waveformPlot} alt="waveform" />
...
<R2Image key={lossPlot} alt="loss and validation loss graph" />
