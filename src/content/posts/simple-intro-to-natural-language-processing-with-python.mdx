...
import mfccPlot from '../../assets/posts/simple-intro-to-natural-language-processing-with-python/mfcc.png';
import waveformPlot from '../../assets/posts/simple-intro-to-natural-language-processing-with-python/waveform-1.png';
import lossPlot from '../../assets/posts/simple-intro-to-natural-language-processing-with-python/loss.png';
