...
cover:
  image: /static/assets/posts/piserver/piserver-intro.jpeg
  alt: PiServer
tags: ['project']
---
...
export const raspberryPiImage = '/static/assets/posts/piserver/raspberry-pi4.jpg';
export const macProImage = '/static/assets/posts/piserver/mac-pro.jpg';
export const failedPrototypeImage = '/static/assets/posts/piserver/piserver_failed_prototype.jpg';
export const scrapsImage = '/static/assets/posts/piserver/scraps.jpg';
export const piServerCornerImage = '/static/assets/posts/piserver/piserver-corner.jpg';
export const piServerRgbImage = '/static/assets/posts/piserver/piserver_rgb.jpg';

export const piServerGallery = [
  '/static/assets/posts/piserver/piserver_front.jpg',
  '/static/assets/posts/piserver/piserver_full.jpg',
  '/static/assets/posts/piserver/piserver_left.jpg',
  '/static/assets/posts/piserver/piserver_right.jpg',
  '/static/assets/posts/piserver/piserver_top_nofan.jpg',
  '/static/assets/posts/piserver/piserver_top.jpg',
  '/static/assets/posts/piserver/piserver1.jpg',
  '/static/assets/posts/piserver/piserver3-3.jpg',
  '/static/assets/posts/piserver/piserver5.jpg'
];
...
<PostImage
  key={raspberryPiImage}
  alt="Raspberry Pi 4 SBC (Single-Board Computer)"
  maxWidth="600px"
/>
...
<PostImage key={macProImage} alt="Apple Mac Pro 2013" />
...
<PostImage key={failedPrototypeImage} alt="Failed prototype due to hard-to-remove supports" />
...
<PostImage key={scrapsImage} alt="Scrap corner" />
...
<PostImageGallery
  images={[
    { key: piServerGallery[0] },
    { key: piServerGallery[1] },
    { key: piServerGallery[2] },
    { key: piServerGallery[3] },
    { key: piServerGallery[4] },
    { key: piServerGallery[5] },
    { key: piServerGallery[6] },
    { key: piServerGallery[7] },
    { key: piServerGallery[8] }
  ]}
  columns={3}
/>

Check out the [PiServer Media Gallery](/piserver-gallery) for **more photos & videos**.
...
<PostImage key={piServerCornerImage} alt="PiServer powering LED light strip" maxWidth="400px" />
